...
class Clementine
{
    ...
    public function getBlock($path, $data = null, $ignores = array(), $load_parent = false, $testonly = false)
    {
        ...
        if (__DEBUGABLE__ && !$found && !$testonly) {
            $this->getController('debug')->err404_noSuchBlock($path);
        }
        return $found;
    }
    ...
    public function apply_config()
    {
        ...
        if (__DEBUGABLE__ && Clementine::$config['clementine_debug']['overrides']) {
            $message = '<table width="300" style="font-size: 12px; line-height: 1.4em; text-align: left; "><thead><tr><th>module</th><th>version</th><th>type</th><th>poids</th></tr></thead><tbody>';
